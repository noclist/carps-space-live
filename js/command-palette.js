...
const portfolioPages = [
  // Main
  { title: 'Techniques', icon: '⚡', url: 'tech23-v2.html', category: 'Main', tags: ['techniques', 'demos', 'css'] },
  ...
  // Technique Demos
  { title: 'Container Queries', icon: '🧱', url: 'container-v2.html', category: 'Techniques', desc: 'LEGO Collection demo', tags: ['container', 'queries', 'responsive', 'lego'] },
  { title: ':has() Selector', icon: '🎯', url: 'has.html', category: 'Techniques', desc: 'Parent selector demo', tags: ['has', 'selector', 'parent'] },
  { title: 'Meet Our Team', icon: '👥', url: 'modular.html', category: 'Techniques', desc: 'Flexbox grid cards', tags: ['team', 'cards', 'flexbox'] },
  { title: 'Book Library', icon: '📚', url: 'books.html', category: 'Techniques', desc: 'CSS Grid layout', tags: ['books', 'library', 'grid'] },
  { title: 'Monster Movies', icon: '🎬', url: 'nav-godzilla.html', category: 'Techniques', desc: 'View Transitions API', tags: ['movies', 'monsters', 'transitions'] },
  { title: 'Toy Shop', icon: '🧸', url: 'toy.html', category: 'Techniques', desc: 'Grid layout', tags: ['toy', 'shop', 'ecommerce'] },
  { title: 'The Pop Show', icon: '🎤', url: 'zpattern.html', category: 'Techniques', desc: 'Z-Pattern layout', tags: ['landing', 'zpattern'] },
  { title: 'Streaming Grid', icon: '🎮', url: 'streaming.html', category: 'Techniques', desc: '3D Grid', tags: ['streaming', '3d', 'grid'] },
  ...
  { title: 'Cleveland Travel', icon: '✈️', url: 'cle-travel.html', category: 'Techniques', desc: 'Responsive design', tags: ['travel', 'responsive'] },
  { title: 'NBA JAM', icon: '🏀', url: '4up.html', category: 'Techniques', desc: '4-Up layout', tags: ['nba', 'sports', 'layout'] },
  { title: 'Course Registration', icon: '📝', url: 'course.html', category: 'Techniques', desc: 'Form design', tags: ['course', 'form', 'registration'] },
  { title: 'Tilting Card', icon: '🃏', url: 'tilting.html', category: 'Techniques', desc: '3D card effect', tags: ['tilt', 'card', '3d'] },
  
  // CSS Art
  { title: 'CSS Art Gallery', icon: '🎨', url: 'art.html', category: 'CSS Art', tags: ['art', 'gallery', 'creative'] },
